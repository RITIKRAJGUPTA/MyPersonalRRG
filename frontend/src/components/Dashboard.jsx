  ...
  const downloadMonthlyReport = async () => {
    ...
    try {
      ...
      const totals = {
        ...
        "Chai/Coffee": excelData.reduce(
          (sum, row) => sum + row["Chai/Coffee"],
          0,
        ),
        "Fast Food": excelData.reduce((sum, row) => sum + row["Fast Food"], 0),
        Transport: excelData.reduce((sum, row) => sum + row["Transport"], 0),
        "Bills/Recharge": excelData.reduce(
          (sum, row) => sum + row["Bills/Recharge"],
          0,
        ),
        Shopping: excelData.reduce((sum, row) => sum + row["Shopping"], 0),
        Entertainment: excelData.reduce(
          (sum, row) => sum + row["Entertainment"],
          0,
        ),
        "Sent Money": excelData.reduce(
          (sum, row) => sum + row["Sent Money"],
          0,
        ),
        "Loan Repayment": excelData.reduce(
          (sum, row) => sum + row["Loan Repayment"],
          0,
        ),
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p>
                      ...
                      {monthlySummary.totalFood}
                    </p>
                    <p>
                      <span className="font-medium">Grocery:</span> ₹
                      {monthlySummary.totalGrocery}
                    </p>
                    <p>
                      <span className="font-medium">Chai/Coffee:</span> ₹
                      {monthlySummary.totalChaiCoffee || 0}
                    </p>
                    <p>
                      <span className="font-medium">Fast Food:</span> ₹
                      {monthlySummary.totalFastFood || 0}
                    </p>
                    <p>
                      <span className="font-medium">Transport:</span> ₹
                      {monthlySummary.totalTransport || 0}
                    </p>
                    <p>
                      <span className="font-medium">Bills:</span> ₹
                      {monthlySummary.totalBills || 0}
                    </p>
                    <p>
                      <span className="font-medium">Shopping:</span> ₹
                      {monthlySummary.totalShopping || 0}
                    </p>
                    <p>
                      <span className="font-medium">Entertainment:</span> ₹
                      {monthlySummary.totalEntertainment || 0}
                    </p>
                    <p>
                      <span className="font-medium">Extra:</span> ₹
                      {monthlySummary.totalExtra}
                    </p>
                    <p>
                      <span className="font-medium">Sent Money:</span> ₹
                      {monthlySummary.totalSentMoney}
                    </p>
                    <p>
                      <span className="font-medium">Loan Repayment:</span> ₹
                      {monthlySummary.totalLoanRepayment || 0}
                    </p>
                    <p>
                      <span className="font-medium">Other:</span> ₹
                      {monthlySummary.totalOther}
                    </p>
                    <p>
                      <span className="font-medium">Daily Average:</span> ₹
                      {monthlySummary.dailyAverage?.toFixed(2) || 0}
                    </p>
                    <p>
                      <span className="font-medium">Days with entries:</span>{" "}
                      {monthlySummary.daysWithEntries}
                    </p>
                  </div>
                </div>
              )}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          value={expenses.food}
                          onChange={(e) =>
                            handleExpenseChange("food", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 80"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("grocery", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 500"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("chaiCoffee", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 12"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("fastFood", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 50"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("transport", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 40"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("bills", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 900"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("entertainment", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 50"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("sentMoney", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 440"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("loanRepayment", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 2000"
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleExpenseChange("extra", e.target.value)
                          }
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          placeholder="e.g., 25"
                        />
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mb-6 p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Downloads a detailed Excel report with all expense categories,
                daily breakdown, and monthly totals.
              </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-2xl font-bold text-blue-600">
                      ₹
                      {(
                        getHistoryTotal(historyData) / historyData.length
                      ).toFixed(2)}
                    </p>
                  </div>
                </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {historyData.map((item) => (
                        <tr key={item._id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.food || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.grocery || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.chaiCoffee || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.fastFood || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.transport || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.bills || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.shopping || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.entertainment || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.sentMoney || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.loanRepayment || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            ₹{item.expenses.extra || 0}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
