...
const Dashboard = () => {
  ...
  // Do NOT use toISOString() for date-only values.
  ...
  // Avoids JavaScript interpreting YYYY-MM-DD as UTC.
  ...
  // =========================================================
  // FETCH ROUTINE WHEN SELECTED DATE CHANGES
  // =========================================================
  ...
  // =========================================================
  // FETCH ROUTINE FOR SELECTED DATE
  // =========================================================
  ...
  const fetchRoutine = async () => {
    try {
      ...
      if (response.data.data) {
        ...
        const exp = routineData.expenses || {};
        ...
        setThought(routineData.thought || '');

        setExpenseItems(
          routineData.expenseItems || []
        );
      } else {
        resetForm();
      }
    ...
    try {
      ...
      // -----------------------------------------------------
        ...
        if (!weekNum || weekNum < 1 || weekNum > 53) {
          toast.error(
            'Please enter a valid week number between 1 and 53'
          );
      ...
      if (!startDate || !endDate) {
        toast.error(
          'Unable to determine selected date range'
        );
  ...
  const downloadMonthlyReport = async () => {
    ...
    try {
      ...
      const totals = {
        ...
        Food: excelData.reduce(
          (sum, row) =>
            sum + row.Food,
          0
        ),

        Grocery: excelData.reduce(
          (sum, row) =>
            sum + row.Grocery,
          0
        ),
        ...
        'Fast Food': excelData.reduce(
          (sum, row) =>
            sum + row['Fast Food'],
          0
        ),

        Transport: excelData.reduce(
          (sum, row) =>
            sum + row.Transport,
          0
        ),
        ...
        'Bills/Recharge': excelData.reduce(
          (sum, row) =>
            sum + row['Bills/Recharge'],
          0
        ),

        Shopping: excelData.reduce(
          (sum, row) =>
            sum + row.Shopping,
          0
        ),
        ...
        'Loan Repayment':
          excelData.reduce(
            (sum, row) =>
              sum + row['Loan Repayment'],
            0
          ),

        Extra: excelData.reduce(
          (sum, row) =>
            sum + row.Extra,
          0
        ),

        Other: excelData.reduce(
          (sum, row) =>
            sum + row.Other,
          0
        ),

        Total: excelData.reduce(
          (sum, row) =>
            sum + row.Total,
          0
        ),
      ...
      const fileName =
        `Expense_Report_${monthName}_${year}.xlsx`;
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p>
                        ...
                        ₹
                        {monthlySummary.totalSentMoney || 0}
                      </p>
                      ...
                      <p>
                        ...
                        {monthlySummary.dailyAverage
                          ? monthlySummary.dailyAverage.toFixed(2)
                          : '0.00'}
                      </p>
                      ...
                      {historyData.map(
                        (item) => (
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              ₹
                              {item.expenses?.grocery ||
                                0}
                            </td>

                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              ₹
                              {item.expenses?.chaiCoffee ||
                                0}
                            </td>

                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              ₹
                              {item.expenses?.fastFood ||
                                0}
                            </td>

                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              ₹
                              {item.expenses?.transport ||
                                0}
                            </td>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              ₹
                              {item.expenses?.shopping ||
                                0}
                            </td>

                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              ₹
                              {item.expenses?.entertainment ||
                                0}
                            </td>

                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              ₹
                              {item.expenses?.sentMoney ||
                                0}
                            </td>

                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                              ₹
                              {item.expenses?.loanRepayment ||
                                0}
                            </td>
